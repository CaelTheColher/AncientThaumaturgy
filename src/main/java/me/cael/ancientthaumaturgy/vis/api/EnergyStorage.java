...
import me.cael.ancientthaumaturgy.vis.api.base.SimpleSidedEnergyContainer;
import me.cael.ancientthaumaturgy.vis.impl.EnergyImpl;
...
public interface EnergyStorage {
	...
	BlockApiLookup<EnergyStorage, Direction> SIDED =
			BlockApiLookup.get(new Identifier("ancientthaumaturgy:sided_vis"), EnergyStorage.class, Direction.class);
	...
	ItemApiLookup<EnergyStorage, ContainerItemContext> ITEM =
			ItemApiLookup.get(new Identifier("ancientthaumaturgy:vis"), EnergyStorage.class, ContainerItemContext.class);
